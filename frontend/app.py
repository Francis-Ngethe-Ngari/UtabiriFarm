...
def main():
    ...
    backend_url = 'http://44.200.35.208/predict'  # Adjust the URL if needed

    # Path to the prediction history file
    prediction_file = '/home/sudotechpro/alx_learn/UtabiriFarm/model/predictions/predictions.txt'
